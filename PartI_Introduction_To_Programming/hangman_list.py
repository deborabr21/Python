...
def hangman(word):
    ...
    wordlist = ["red", "blue", "green", "purple", "yellow", "orange"]
    ...
    while wrong < len(stages) - 1:
        ...
        msg = "Guess a letter: "
        char = input(msg)
        # You check to see if player guessed correctly by seeing if their guess is in the list of remaining letters
        for i in range(len(word)):
            if char in rletters:
                # If player guessed correctly you need to update your board list.
